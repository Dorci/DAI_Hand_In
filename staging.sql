...
INSERT INTO StagingDatabase.staging.stage_dim_product(product_id, name, valid_from, valid_to)
...
INSERT INTO StagingDatabase.staging.stage_f_sales(business_customer_id, business_product_id, business_order_date, quantity, line_total)
